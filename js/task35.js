...
function checkForName(fullName, name) {
   ...
   checkForName('Егор Колбасов', 'Егор');// возвращает true.
    ...
    checkForName('Егор Колбасов', 'егОр');// возвращает false.
    checkForName('Егор Колбасов', 'Женя');// возвращает false.
    checkForName('Вадим Некрасов', 'Вадим');// возвращает true.
    checkForName('Вадим Некрасов', 'вадим');// возвращает false.
    checkForName('Вадим Некрасов', 'Дима');// возвращает false.
